...
b16 = new LeaderLine(b1, LeaderLine.pointAnchor(b6, {x: '0%', y: '10%'}),
...
b23 = new LeaderLine(b2, LeaderLine.pointAnchor(b3, {x: '0%', y: '50%'}),
      {startPlug: 'disc',endPlug: 'arrow3', middleLabel: LeaderLine.pathLabel('y(n)', {fontFamily: 'Arial, sans-serif'})});
b26 = new LeaderLine(b2, LeaderLine.pointAnchor(b6, {x: '0%', y: '30%'}),
...
b34 = new LeaderLine(b3, LeaderLine.pointAnchor(b4, {x: '0%', y: '80%'}),
      {startPlug: 'disc',endPlug: 'arrow3', middleLabel: LeaderLine.pathLabel('q(n)', {fontFamily: 'Arial, sans-serif'})});
b36 = new LeaderLine(b3, LeaderLine.pointAnchor(b6, {x: '0%', y: '50%'}),
      {startPlug: 'disc',endPlug: 'arrow3', middleLabel: LeaderLine.pathLabel('q(n)', {fontFamily: 'Arial, sans-serif'}),endLabel: LeaderLine.pathLabel('Ch3', {fontFamily: 'Arial, sans-serif'})}); 
b45 = new LeaderLine(b4, LeaderLine.pointAnchor(b5, {x: '0%', y: '80%'}),
      {startPlug: 'disc',endPlug: 'arrow3', middleLabel: LeaderLine.pathLabel('c(n)', {fontFamily: 'Arial, sans-serif'})});
b46 = new LeaderLine(b4, LeaderLine.pointAnchor(b6, {x: '0%', y: '75%'}),
      {startPlug: 'disc',endPlug: 'arrow3', middleLabel: LeaderLine.pathLabel('c(n)', {fontFamily: 'Arial, sans-serif'}),endLabel: LeaderLine.pathLabel('Ch4', {fontFamily: 'Arial, sans-serif'})}); 
b56 = new LeaderLine(b5, LeaderLine.pointAnchor(b6, {x: '0%', y: '90%'}),
      {startPlug: 'disc',endPlug: 'arrow3', middleLabel: LeaderLine.pathLabel('e(n)', {fontFamily: 'Arial, sans-serif'}),endLabel: LeaderLine.pathLabel('Ch5', {fontFamily: 'Arial, sans-serif'})});       
  ...
  new PlainDraggable(b2, {
    ...
    ckt=0,
    plt(0),
    b12.position(),b23.position(), b26.position();}}); 
  ...
  new PlainDraggable(b3, {
    ...
    ckt=0,
    plt(0),
    b23.position(),b34.position(),b36.position();}});
    ...
    new PlainDraggable(b4, {
      ...
      ckt=0,
      plt(0),
      b34.position(),b45.position(), b46.position() ;}});
      ...
      new PlainDraggable(b5, {
        ...
        new PlainDraggable(b6, {
          ...
          ckt=0,
          plt(0),
          b16.position(),b26.position(),b36.position(),b46.position(),b56.position(); }
          });
  var ckt=0;
  var ch=0;
  var clp=0;
...
$(document).ready(function(){
    ...
    $("#s1").click(function(){
      ...
      $("#pa").slideDown("slow");
        ...
        b16.dash = {animation: true};
        b23.dash = {animation: true};
        b26.dash = {animation: true};
        b34.dash = {animation: true};
        b36.dash = {animation: true};
        b45.dash = {animation: true};
        b46.dash = {animation: true};
      ...
      b16.dash = {animation: false};
      b23.dash = {animation: false};
      b26.dash = {animation: false};
      b34.dash = {animation: false};
      b36.dash = {animation: false};
      b45.dash = {animation: false};
      b46.dash = {animation: false};
